        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex gap-2">
              ...
              <button onClick={() => { setInviting(!inviting); setError(null); }}
                className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-slate-900 font-semibold px-4 py-2.5 rounded-xl text-sm">
                {inviting
          ...
          {inviting && (
            <form onSubmit={invite}
              className="bg-white border border-indigo-700/60 rounded-xl p-5 mb-5 space-y-4">
              <h3 className="font-semibold text-slate-900 flex items-center gap-2">
                <FiShield className="w-4 h-4 text-indigo-600" /> Invite New User
              </h3>
              ...
              <div className="flex gap-2">
                <button type="submit" disabled={saving}
                  className="bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 text-slate-900 font-semibold px-4 py-2 rounded-lg text-sm">
                          ...
                          {editingId === u.id ? (
                            <div className="flex items-center gap-1">
                              ...
                              <button onClick={() => updateRole(u.id, editRole)}
                                className="text-green-600 hover:text-green-300 text-xs px-2 py-1 bg-green-900/30 rounded">Save</button>
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-1">
                            <button
                              ...
                              title="Change role"
                              className="p-1.5 text-slate-400 hover:text-indigo-400 hover:bg-slate-100 rounded">
