      ...
      <main className="min-h-screen bg-gray-950 py-8">
        <div className="max-w-3xl mx-auto px-4">
            ...
            {TABS.map(t => (
              <button key={t.id} onClick={() => setTab(t.id)}
                className={`flex items-center gap-2 px-5 py-3 text-sm font-medium transition-colors ${
                  tab === t.id ? "border-b-2 border-indigo-500 text-indigo-400" : "text-gray-500 hover:text-white"
                }`}>
                {t.icon}{t.label}
              </button>
            ))}
          ...
          {loading ? (
            ...
            <>
              {tab === "general" && (
                <form onSubmit={save} className="bg-gray-900 border border-gray-800 rounded-xl p-6 space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input value={me?.user?.role || ""} disabled
                        className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-400 text-sm cursor-not-allowed capitalize"/>
                    </div>
                    <div>
                  ...
                  <div className="border-t border-gray-800 pt-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="block text-xs text-gray-400 mb-1">Org Name</label>
                  ...
                  <button type="submit" disabled={saving}
                    className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 text-white font-semibold px-5 py-2.5 rounded-lg text-sm">
                ...
                <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 space-y-4">
                  ...
                  <div className="space-y-3 text-sm text-gray-400">
                    <div className="flex justify-between items-center py-3 border-b border-gray-800">
                      ...
                      <button className="text-indigo-400 hover:text-indigo-300 text-sm">Change →</button>
                    </div>
                    <div className="flex justify-between items-center py-3 border-b border-gray-800">
                      <div>
                      ...
                      <span className="text-xs text-gray-600 bg-gray-800 px-2 py-0.5 rounded">Not enabled</span>
                    </div>
                    <div className="flex justify-between items-center py-3">
                      ...
                      <button className="text-red-400 hover:text-red-300 text-sm">Sign out all →</button>
                    </div>
                  </div>
                </div>
              )}
              ...
              {tab === "api" && (
                <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
                  ...
                  <a href="/enterprise" className="text-indigo-400 hover:text-indigo-300 text-sm">
